...
| — | [best-ensemble.md](best-ensemble.md) | **Living tracker** of the best ensemble submission — with full base-model dependency chain, reproduction commands, per-target blend weights, and ensemble history. Ensembles are painful to reproduce without this. |
