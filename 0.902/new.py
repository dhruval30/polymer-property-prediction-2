...
WORK_DIR = (Path("/kaggle/working") if ON_KAGGLE else _HERE) / "work_0902"

# Kaggle expects the graded file at exactly /kaggle/working/submission.csv
FINAL_SUB_PATH = Path("/kaggle/working/submission.csv") if ON_KAGGLE else _HERE / "submission.csv"
